...
| **Day 3** | 2026-07-18 | [day03.md](day03.md) | [day03_en.md](day03_en.md) | QLoRA 2B trên 4GB chết (WDDM 112s/bước) → quyết định "kiến trúc của chúng ta" → **JWM-Read**: mắt 768px merge 2×2 = 576 token, 168M/91M active, CER metric, 21.6K doc-QA + synthetic vô hạn, lazy+prefetch → notebook Kaggle T4, train commit 11.5K bước đang chạy (tok_acc ~0.78) |
