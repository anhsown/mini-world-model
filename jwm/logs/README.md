...
| **Day 5** | 2026-07-20 | [day05.md](day05.md) | [day05_en.md](day05_en.md) | Eye Physical v1 fail TUM dynamic OOD → BLOCK; dựng **Eye v2 pairwise metric** + Tartan/TUM/Bonn validation + causal ablation A–D; 86.77M/12.91M trainable, 107 tests và AMP 8-frame pass, chờ train T4×2 |
